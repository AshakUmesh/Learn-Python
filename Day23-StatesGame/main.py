...
while len(guess_state) < 29:
    users_input_state = screen.textinput(title=f"{len(guess_state)}/29 Correct State",
...
remaining_state = [states for states in state_list if states not in guess_state]
